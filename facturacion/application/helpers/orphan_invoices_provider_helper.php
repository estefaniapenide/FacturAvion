...
function delete_orphans()
{
    ...
    $queries = array(
        'DELETE FROM ip_invoices_provider WHERE provider_id NOT IN (SELECT provider_id FROM ip_providers)',
        ...
        'DELETE FROM ip_payment_custom WHERE payment_id NOT IN (SELECT payment_id FROM ip_payments_provider)',
        ...
        'DELETE FROM ip_invoice_provider_item_amounts WHERE item_id NOT IN (SELECT item_id FROM ip_invoice_provider_items)',
