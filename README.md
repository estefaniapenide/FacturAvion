...
- Edición de archivos:
 ...
 - Idiomas
    - Añade las siguientes lineas en ```application/language/english/custom_lang.php```
    ...
    - Añade las siguientes lineas en ```application/language/Spanish/custom_lang.php```
